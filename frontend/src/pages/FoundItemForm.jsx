...
export default function FoundItemForm(){
  ...
  return (
    <Box sx={{ p: 2 }}>
      <p className="text-sm text-gray-600 mb-2">(Email or phone numbers help others contact you if they find your item.)</p>
      ...
      <TextField label="Finder mobile (optional)" placeholder="digits only" maxLength="10" fullWidth value={mobile} onChange={e=>setMobile(e.target.value)} sx={{ mb:2 }} />
      <TextField label="Finder alternate mobile (optional)" placeholder="digits only" maxLength="10" fullWidth value={altMobile} onChange={e=>setAltMobile(e.target.value)} sx={{ mb:2 }} />
